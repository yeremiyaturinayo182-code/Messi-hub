...
local buttonsPagesData = {
    ...
    {Text = "LAG", ScriptLink ="https://pastebin.com/raw/TkCL2MhS"},

    {Text = "NO COOLDOWN", ScriptLink = "https://pastebin.com/raw/2Ck4F28u"},
    ...
    {Text = "SPEED", ScriptLink = "https://pastebin.com/raw/vHiPt5sP"},

    {Text = "HITBOX", ScriptLink = "https://pastebin.com/raw/aNay6q2J"},

    {Text = "SCRIPT 15", ScriptLink = "https://pastebin.com/raw/TkCL2MhS"},
...
titleLabel.Text = "💀MESSI DEATH HUB💀"
...
for i = 1, #buttonsPagesData do
    ...
    button.MouseButton1Click:Connect(function()
        ...
        print("💀 Death Button " .. i .. " - " .. buttonsPagesData[i].Text .. " activated!")
...
print("💀🩸 MESSI DEATH HUB - Script Hub Loaded! 🩸💀")
